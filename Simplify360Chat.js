...
const Simplify360Chat = (function () {
  ...
  const changeChatPosition = () => {
    ...
    if (chatFrame) {
      chatFrame.style = `position: fixed;${chatStatus === "closed" ? ' top: calc(100vh - 6rem)' : `bottom:1rem;`};${chatPosition}:0;overflow: visible;z-index: 99999;HEIGHT:${chatStatus === "closed" ? "5rem" : "100%"
  ...
  const onChatOpen = () => {
    ...
    if (chatFrame) {
      ...
      if (mq.matches) {
        chatFrame.style =
          "position: fixed;width: 100%;height:100%!important;bottom: 0;right:0;overflow: visible;z-index: 99999; -webkit-transition: all 0.3s;-moz-transition: all 0.3s;-ms-transition: all 0.3s;-o-transition: all 0.3s;transition: all 0.3s;";
      } else {
        // let height = window.screen.height * 0.75 + 110;
        //note::max-height:750px;
        chatFrame.style = `position: fixed; display: flow-root;width: 100%; max-width:${deviceViewedOn === "mobile" ? '100%' : '24rem'};  height:100%!important;${chatPosition}:0;bottom:0;overflow: visible;z-index: 99999; -webkit-transition: all 0.3s;-moz-transition: all 0.3s;-ms-transition: all 0.3s;-o-transition: all 0.3s;transition: all 0.3s;`;
      ...
      if (
        ...
        if (mq.matches) {
          chatFrame.style = `position: fixed;width: 100%;height:100%;bottom: 0;${chatPosition}:0;overflow: visible;z-index: 99999; -webkit-transition: all 0.3s;-moz-transition: all 0.3s;-ms-transition: all 0.3s;-o-transition: all 0.3s;transition: all 0.3s;`;
        } else {
  ...
  const onChatClose = () => {
    ...
    let chatFrame = window.document.getElementById("s360-chat-iframe");
    if (chatFrame) {
      chatFrame.style = `position: fixed;top:calc(100vh - 6rem);${chatPosition}:0; overflow: visible;z-index: 99999;height:${chatStatus === "closed" ? "5rem" : "100%"
